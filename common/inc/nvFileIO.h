...
inline void nvGetFileSize(HANDLE hInputFile, long long *pFilesize)
{
#if defined (NV_WINDOWS)
    ...
    if (hInputFile != INVALID_HANDLE_VALUE)
    {
		...
		if (pFilesize != NULL) *pFilesize = ((LONGLONG)file_size.HighPart << 32) + (LONGLONG)file_size.LowPart;// file_size.LowPart;
    }
